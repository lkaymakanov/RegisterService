...
public class DbStatementLogUtilizer {
	...
	public static void printDBStatementClassesInTransaction(Log LOG, DBStatement[] statements){
	 ...
	 */
	public static void printExceptionToConsole(Log LOG, Exception ex){
		if(ex != null){
	 ...
	 * @param statements
	 */
	public static void printErrSqlStatement(Log LOG, DBStatement[] statements){
	 ...
	 * @param statements
	 */
	public static void printSqlStatement(Log LOG, DBStatement[] statements){
		DBStatementDetails details;
		for(int i = 0; i < statements.length ; i++){
			if(statements[i] != null){
				details = statements[i].getDetails();
	...
	public static void printErrSqlStatement(Log LOG, DBStatement statement){
		DBStatement dbst  [] = new DBStatement[1];
		dbst[0] = statement;
		printErrSqlStatement(LOG, dbst);
	}
	
	public static void printSqlStatement(Log LOG, DBStatement statement){
		DBStatement dbst  [] = new DBStatement[1];
		dbst[0] = statement;
	...
	private static void printDetails(Log LOG, DBStatementDetails details){
	 ...
	 */
	public static void printTimeConsumingDBStatement(Log LOG, DBStatement statement,  long upperboundTime){
